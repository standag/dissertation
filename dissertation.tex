...
% Pripominky, dotazy, namety smerujte na diskusni forum: 
% https://is.muni.cz/auth/discussion/sablona-prif/                                      %%%
% Typeset in LaTeX-2e                                                                   %%%
...
% \usepackage[T1]{fontenc} %% puvodni evropske fonty
%% ->spatne umistene hacky nad c, d s hackem ma za sebou mezeru
...
%%
%% pri volbe bez babelu bude zlobit v ukazkovych souborech prikaz 
%%``\shorthandoff{-}'' a ``\shorthandoff{-}''
%% ty staci vymazat a je to bez problemu
%%
%% pri volbe ``\usepackage[english]{babel}'' nefunguji ceske uvozovky 
%% pomoci \uv{..} - staci nahradit ``..''
%%%%%%%%%%%%
...
%%%%%%%%%%%%
%% Muzete si zkusit zmenit font dokumentu - pak ale musite v souboru zmenit nektera 
%% nastaveni (nebot je nastaveno
...
%  \usepackage[mtbold,mtplusscr,mtpluscal]{mathtime} % komercni matematicky font, 
% dostupne pouze na UMS
...
%%% balik ``longtable`` je potrebny pro sazeni kapitoly s pouzitym znacenim, 
%%% jinak neni potreba
%%% balik ``lipsum`` je pouze pro sablonu, aby se generoval nahodny text - pro samotnou 
%%% praci je mozne jej odstranit
...
\AkademickyRok{2020/2021}

\Autor{Stanislav Geidl}{RNDr. Stanislav Geidl}

\NazevPrace{Title}{Title}{Title}
...
\VedouciPraceSTituly{prof. RNDr. Jaroslav Koča, DrSc.}

\StudijniProgram{Biomolekulární chemie a bioinformatika}{Biomolecular chemistry and bioinformatics}
...
\HlavickaZnaceni
\vloz{parts/01_introduction}
\cleardoublepage

\HlavickaUvod
\setcounter{page}{1}
\pagenumbering{arabic}
\vloz{parts/02_theory_and_methods}
\cleardoublepage

%\renewcommand{\chaptermark}[1]{\markboth{\thechapter. #1}{}}
%\renewcommand{\sectionmark}[1]{\markright{\thesection. #1}{}}
%\HlavickaKapitoly
\vloz{parts/03_results}
\cleardoublepage

\vloz{parts/04_conclusion}
\cleardoublepage
