...
\clearpage
  ...
  \begin{center}\vspace*{3mm}
  %\includegraphics[width=60mm]{MUNI_(black)} \\
    {\fontsize{28pt}{28pt}\selectfont{\textbf{MASARYK UNIVERSITY}}}\\[2mm]
    {\fontsize{26pt}{28pt}\selectfont{\textbf{Faculty of Science}}}\\[1mm] %textsc
    {\fontsize{18pt}{28pt}\selectfont{\textbf{National Centre for Biomolecular Research}}}\\[1mm] %textsc
  \end{center}
 ...
 \vspace{3cm}
  ...
  \begin{center}
      ...
      \vspace{1cm}
      {\fontsize{20pt}{26pt}\selectfont{Dissertation}} \\
      \vspace{1cm}
      {\fontsize{24pt}{26pt}\selectfont{Stanislav Geidl}} \\
  \end{center}
